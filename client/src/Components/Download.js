  ...
  render() {
    return (
        <div className="download-page-main">
          ...
          <p id="install-info">
            Current Version: 24.1.0 released 2019-10-07 <br/>
            <br/>
            All versions have exactly the same functionality. They only differ in
          ...
          <div id="download-card">
            ...
            <div>
              ...
              <p>
                Click to install the extension from the official Mozilla Firefox
                Add-Ons site. <br/>
                <b>Are You Upgrading?</b> Firefox will update automatically every
                24 hours or less. The "Download" page may not show you the latest
                version. To update Social Fixer manually, see:
                <br/>
                <Link to="/">
              ...
              <div id="download-card">
                ...
                <p>Click to install the extension from the official Mozilla Firefox Add-Ons site. <br/>
                  <b>Are You Upgrading?</b> Firefox will update automatically every 24 hours or less. The "Download"
                  page may not show you the latest version. To update Social Fixer manually, see:<br/>
